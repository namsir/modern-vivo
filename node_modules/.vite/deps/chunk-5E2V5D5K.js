...
// node_modules/vidstack/dev/chunks/vidstack-BYNmVJLa.js
...
var TextTrack = class extends EventsTarget {
  ...
  #parseContent(init) {
    import("./dev-CXMF3G5O.js").then(({ parseText, VTTCue, VTTRegion }) => {
  ...
  async #load() {
    ...
    try {
      const { parseResponse, VTTCue, VTTRegion } = await import("./dev-CXMF3G5O.js"), crossOrigin = this[TextTrackSymbol.crossOrigin]?.();
...
//# sourceMappingURL=chunk-5E2V5D5K.js.map
