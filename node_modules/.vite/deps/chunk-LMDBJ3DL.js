...
// node_modules/vidstack/dev/chunks/vidstack-7RO-J1Y1.js
...
var MediaRemoteControl = class {
  ...
  #dispatchRequest(type, trigger, detail) {
    ...
    {
      this.#logger?.debugGroup(`📨 dispatching \`${type}\``).labelledLog("Target", target).labelledLog("Player", this.#player).labelledLog("Request Event", request).labelledLog("Trigger Event", trigger).dispatch();
    }
    if (this.#player) {
...
var MediaKeyboardController = class extends MediaPlayerController {
  ...
  #onKeyDown(event) {
    ...
    if (!method2 && isNumberPress && !modifierKeyPressed(event)) {
      event.preventDefault();
      event.stopPropagation();
...
var AudioProviderLoader = class {
  ...
  async load(ctx) {
    ...
    return new (await import("./vidstack-audio-FQTVYJ7F.js")).AudioProvider(this.target, ctx);
  }
};
var VideoProviderLoader = class {
  ...
  async load(ctx) {
    ...
    return new (await import("./vidstack-video-MUZCER5F.js")).VideoProvider(this.target, ctx);
  }
};
var HLSProviderLoader = class _HLSProviderLoader extends VideoProviderLoader {
  ...
  async load(context) {
    ...
    return new (await import("./vidstack-hls-CYYWH6UG.js")).HLSProvider(this.target, context);
  }
};
var DASHProviderLoader = class _DASHProviderLoader extends VideoProviderLoader {
  ...
  async load(context) {
    ...
    return new (await import("./vidstack-dash-2LCHLSAJ.js")).DASHProvider(this.target, context);
  }
};
var VimeoProviderLoader = class {
  ...
  async load(ctx) {
    ...
    return new (await import("./vidstack-vimeo-3EAFYVGY.js")).VimeoProvider(this.target, ctx);
  }
  async loadPoster(src, ctx, abort) {
    const { resolveVimeoVideoId, getVimeoVideoInfo } = await import("./vidstack-krOAtKMi-H6J7CESG.js");
...
var YouTubeProviderLoader = class {
  ...
  async load(ctx) {
    ...
    return new (await import("./vidstack-youtube-TMZCFRVD.js")).YouTubeProvider(this.target, ctx);
  }
  async loadPoster(src, ctx, abort) {
    const { findYouTubePoster, resolveYouTubeVideoId } = await import("./vidstack-Dm1xEU9Q-CNLUOFQ7.js");
...
var MediaEventsLogger = class extends MediaPlayerController {
  ...
  #onMediaEvent(event) {
    this.#media.logger?.debugGroup(`📡 dispatching \`${event.type}\``).labelledLog("Media Store", { ...this.$state }).labelledLog("Event", event).dispatch();
  }
};
...
var MediaRequestManager = class extends MediaPlayerController {
  ...
  #handleRequest(event) {
    ...
    {
      this.#media.logger?.infoGroup(`📬 received \`${event.type}\``).labelledLog("Request", event).dispatch();
    }
  ...
  async requestGoogleCast(trigger) {
    try {
      ...
      if (!this.#googleCastLoader) {
        const $module = await import("./vidstack-C0zlo444-C3CSUNZF.js");
...
//# sourceMappingURL=chunk-LMDBJ3DL.js.map
