...
var HTMLMediaEvents = class {
  ...
  #onDevEvent(event2) {
    this.#ctx.logger?.debugGroup(`📺 provider fired \`${event2.type}\``).labelledLog("Provider", this.#provider).labelledLog("Event", event2).labelledLog("Media Store", { ...this.#ctx.$state }).dispatch();
...
//# sourceMappingURL=chunk-WAZFGD6Q.js.map
